...
#' The example code below generates air mass back trajectories for nine station locations. #' Using the matrix method, there are nine air parcel back trajectories run for each      #' station, four times daily. The processing time for the 324 back trajectories will vary
#' from 10-20 min.
